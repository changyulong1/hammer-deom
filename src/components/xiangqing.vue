          ...
          <div class="gallery">
            <div class="thumbnail">
              <ul>
                <li
                  @click="active(index)"
                  :class="{ on: timeshow == index }"
                  v-for="(time, index) in time.ali_images"
                  :key="index"
                >
                  <img
                    :src="
                      time +
                      '?x-oss-process=image/resize,w_45/quality,Q_80/format,webp'
                    "
                  />
                </li>
              </ul>
              ...
              <ul>
                ...
                >
                  <img
                    :src="
                      time +
                      '?x-oss-process=image/resize,w_450/quality,Q_80/format,webp'
                    "
                  />
                </li>
              </ul>
        ...
        <div class="banner">
          ...
          <div class="sku-dynamic-params-panel">
            <div class="sku-dynamic-params clear">
              ...
              <ul class="params-colors">
                <li
                  class="cur"
                  v-for="(time, index) in time.sku_list"
                  :key="index"
                >
                  <router-link
                    :to="{ name: 'xiang', query: { timeid: time.id } }"
                    >{{ time.color }}</router-link
                  >
                </li>
              </ul>
            </div>
            <div class="sku-dynamic-params clear">
              ...
              <div class="params-detail clear">
                <div class="item-num js-select-quantity">
                  ...
                  <span
                    class="up"
                    :class="{ 'up-disabled': count >= time.limit_num }"
                    @click="zeng"
                    >+</span
                  >
                </div>
          ...
          <div class="sku-status">
            <div class="cart-operation-wrapper clearfix">
              <span class="blue-title-btn js-add-cart" @click="goushangpin"
                ><a>加入购物车</a></span
              >
