<template>
  <div class="carousel-wrap" id="carousel">
      <transition-group tag="ul" class="slide-ul" name="list">
          <li v-for="(time,index) in slideList" v-if="currentIndex == index" :key="time.id" @mouseover="stop" @mouseout="go">
      ...
      <div class="carousel-items" >
        <span v-for="(time,ind) in slideList.length" :class="{'active': currentIndex==ind}" :key="ind" @mouseover="gaibian(ind)">
