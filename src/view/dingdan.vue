				...
				<div class="avatar gray-box clear">
					...
					<div class="box-inner">
						<ul class="account-nav"> 
							<router-link :to="{name: 'luyou1'}" exact tag="li" activeClass="current"><a >我的订单</a></router-link>
							<router-link :to="{name: 'luyou2'}" tag="li" activeClass="current"><a href="javascript:;">收货地址</a></router-link> 
						</ul>
					</div>
				</div>
			</div>
